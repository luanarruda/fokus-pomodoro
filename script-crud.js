...
// ➕ Evento de abrir/fechar formulário de adicionar tarefa
...
formAdicionarTarefa.addEventListener('submit', (evento) => {
    ...
    textArea.value = '';
    formAdicionarTarefa.classList.remove('show');
});
...
// ✅ Evento personalizado: tarefa concluída após cronômetro
